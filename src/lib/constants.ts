...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    name: "Capture Studio",
    shortName: "Capture",
    description: "One canvas for notes, voice memos, and YouTube — AI turns everything into searchable knowledge",
    icon: Sparkles,
    color: "#84CC16",
    gradient: "from-lime-500 to-green-600",
    href: "/modules/capture",
    difficulty: "EASY",
    features: ["Markdown + Voice", "YouTube → Notes", "Voice → Notes", "AI Summarisation"],
  },
  {
    id: "recall",
    name: "Recall Arena",
    shortName: "Recall",
    description: "Active recall + spaced repetition in one place — AI quizzes & flashcards tuned to your level",
    icon: Zap,
    color: "#EAB308",
    gradient: "from-yellow-500 to-amber-600",
    href: "/modules/recall",
    difficulty: "EASY",
    features: ["Adaptive MCQs", "Spaced Cards", "Mastery Tracking", "Instant Feedback"],
  },
  {
    id: "news",
    name: "Daily News",
    shortName: "News",
    description: "AI-curated daily news and current affairs, filtered to your exam interests",
    icon: Newspaper,
    color: "#F43F5E",
    gradient: "from-rose-500 to-pink-600",
    href: "/modules/news",
    difficulty: "EASY",
    features: ["AI Curation", "Daily Digest", "Exam-relevant", "Multi-language"],
  },
  {
    id: "exams",
    name: "Upcoming Exams",
    shortName: "Exams",
    description: "Track every exam in your region by interest — countdowns, syllabus, registration alerts",
    icon: CalendarClock,
    color: "#3B82F6",
    gradient: "from-blue-500 to-indigo-600",
    href: "/modules/exams",
    difficulty: "EASY",
    features: ["Region Filter", "Interest Match", "Countdown", "Syllabus Links"],
  },
  {
    id: "insights",
    name: "Learning DNA",
